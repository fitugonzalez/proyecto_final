...
class UserRegisterView(CreateView):
    ...
    template_name = 'proyecto_final/register.html'
...
class CustomLoginView(LoginView):
    template_name = 'proyecto_final/login.html'
...
class ProfileView(LoginRequiredMixin, DetailView):
    model = User
    template_name = 'proyecto_final/profile.html'
...
class AvatarUpdateView(UpdateView):
    ...
    template_name = 'proyecto_final/avatar_form.html'
...
class ProfileUpdateView(LoginRequiredMixin, View):
    template_name = "proyecto_final/edit_profile.html"
    success_url = reverse_lazy("profile")
